...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/fixtures/cas_failure.xml", "spec/fixtures/cas_success.xml", "spec/omniauth/strategies/cas_spec.rb", "spec/omniauth/strategies/ldap_spec.rb", "spec/spec_helper.rb"]
