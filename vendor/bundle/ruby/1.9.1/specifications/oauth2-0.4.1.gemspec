...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/oauth2/access_token_spec.rb", "spec/oauth2/client_spec.rb", "spec/oauth2/strategy/base_spec.rb", "spec/oauth2/strategy/password_spec.rb", "spec/oauth2/strategy/web_server_spec.rb", "spec/spec_helper.rb"]
